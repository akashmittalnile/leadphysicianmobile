...
import { GET_NOTIFICATION, getApiWithToken, CLEAR_NOTIFICATION, requestPostApi, READ_NOTIFICATION, } from '../Global/Service'
            ...
            <TouchableOpacity style={styles.scduleView}>
                <View style={{ flexDirection: 'row' }}>
                    ...
                    <View>
                        ...
                        } fontWeight='400' fontSize={14} textColor={'#959FA6'} fontFamily='Roboto' style={{ textAlign: 'left', marginHorizontal: 16, width: dimensions.SCREEN_WIDTH * 0.60, marginTop: 9 }} />
                    </View>
                </View>
            </TouchableOpacity >
        )
                ...
                <ScrollView
                    ...
                    <View style={{ marginTop: 50 }}>
                        <View style={{ flexDirection: 'row', justifyContent: 'space-between' }}>
                            <MyText text={`Notifications`} fontWeight='500' fontSize={16} textColor={Color.LIGHT_BLACK} fontFamily='Roboto' style={{ textAlign: 'center', }} />

                            {notification.length !== 0 ? <TouchableOpacity onPress={() => { clearAll() }}>
                                <MyText text={'Clear All'} fontWeight='500' fontSize={16} textColor={Color.LIGHT_BLACK} fontFamily='Roboto' style={{ textAlign: 'center', }} />
