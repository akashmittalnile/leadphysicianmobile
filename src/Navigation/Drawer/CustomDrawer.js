...
import {CommonActions, useIsFocused,useNavigation} from '@react-navigation/core';
              ...
              {admincount > 0 ? (
                <View
                  style={{
                    ...
                    {
                       admincount > 10 ?
                       <Text style={{color: Color.WHITE, fontSize: 10,fontWeight:'500'}}>10+
                     </Text>:
                      <Text style={{color: Color.WHITE, fontSize: 10,fontWeight:'500'}}>
                      {admincount}
                    </Text>
                    }
          ...
          <View style={styles.socialMediaContainer}>
            ...
            <View style={[styles.socialRow, {}]}>
              ...
              <TouchableOpacity onPress={gotoLinkedin}>
                <Image
                  source={require('../../Global/Images/linkedin.png')}
                  style={{height: 20, width: 20}}></Image>
              </TouchableOpacity>
              <TouchableOpacity onPress={gotoTwitter}>
                <Image
                  source={require('../../Global/Images/twitter.png')}
                  style={{height: 20, width: 20, marginLeft: 7}}></Image>
              </TouchableOpacity>
              {/* <Image
