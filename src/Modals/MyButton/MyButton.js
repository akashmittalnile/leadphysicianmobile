...
const MyButtons = (props) => {
    return (
        ...
        <TouchableOpacity style={{
            ...
            backgroundColor: props.backgroundColor ? props.backgroundColor : Color.ORANGE,
            ...
            <LinearGradient
                ...
                style={{
                    width: '100%', height: props.height ? props.height : 'auto', alignItems: 'center',
                    justifyContent: 'center'
                }}
                start={{ x: 0, y: 0 }}
                end={{ x: 1, y: 1 }}
            >
                {props.title ?
                    <Text style={{
                        color: props.titlecolor ? props.titlecolor : Color.TEXT_COLOR,
                        textAlign: "center",
