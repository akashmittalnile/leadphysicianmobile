...
const Subscription = ({ navigation }) => {
            ...
            <View style={{ marginBottom: 90 }}>
                <View style={styles.mainView}>
                    ...
                    <View style={{ flexDirection: 'row' }}>
                        ...
                        <ImageBackground
                            source={item?.id === 1 ? require('../../Global/Images/silverMembership.png') : item?.id === 2 ? require('../../Global/Images/goldMembership.png') : require('../../Global/Images/PlataniumMembership.png')}
                            style={{
                                height: 100,
                                width: 100,
                                resizeMode: 'contain',
                ...
                {item?.current_plan === false ?
                    ...
                    >
                        <MyText
                            text={item?.current_plan === false ? `Subscribe Now ` : `Current Plan`}
                            fontWeight='bold'
                            fontSize={16}
                            textColor={Color.WHITE}
                            fontFamily='Roboto'
                    ...
                    >
                        <MyText
                            text={item?.current_plan === false ? `Buy Now Plan` : `Current Plan`}
                            fontWeight='bold'
                            fontSize={16}
    ...
    return (
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: Color.LIGHT_BLACK }}>
            ...
            >
                <CustomHeader navigation={navigation} text="Subscription Plans" type={'subscription'} />
                ...
                <View style={{
                    ...
                    <MyText text='' fontWeight='bold' fontSize={24} textColor={Color.PRIMARY} fontFamily='Roboto' style={{ alignSelf: 'center', marginBottom: 40 }} />
