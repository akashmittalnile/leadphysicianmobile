...
const Signup = ({navigation}) => {
  ...
  const signUpUser = async () => {
    ...
    try {
      ...
      formaData.append('device_id', fcmToken);
      setLoading(true);
      ...
      if (resp.status === true) {
        ...
        await AsyncStorage.setItem(
          'userToken',
          resp?.response?.authorization?.token,
        );
        ...
        <KeyboardAvoidingView
          ...
          <ScrollView keyboardShouldPersistTaps="always" bounces={false}>
            <TouchableOpacity
              ...
              {filePath == '' ? (
                <Image
                  source={require('../../Global/Images/userDefault.png')}
              ...
              <Image
                source={require('../../Global/Images/camera.png')}
                style={{
                  height: 20,
                  width: 20,
                  position: 'absolute',
            ...
            <View
              ...
              <View style={{marginTop: 12}}>
                <CustomTextBox
                  ...
                  placeholder={'Phone'}></CustomTextBox>
              </View>
              <View style={{marginTop: 12}}>
                <CustomTextBox
              ...
              <View
                ...
                <TouchableOpacity
                  style={{marginLeft: 3, marginBottom: 80}}
                  onPress={() => {
