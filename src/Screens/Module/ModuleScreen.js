...
const ModuleScreen = ({navigation, route}) => {
  ...
  const markAsCompleted = async (chapter_step_id, status) => {
    ...
    try {
      const resp = await postApiWithToken(userToken, MARK_COMPLETE, formdata);
    ...
    return (
      <TouchableOpacity
        ...
        <MyIcon
          height={40}
          width={40}
          style={{justifyContent: 'center', marginTop: 12}}></MyIcon>
        ...
        <TouchableOpacity
          style={[styles.arrowView, {backgroundColor: Color.PRIMARY}]}
          onPress={() => {
  ...
  return (
    <SafeAreaView style={{flex: 1}}>
      ...
      <View style={styles.container}>
        <MyHeader
          Title={`Section : ${
            moduleScren?.title !== undefined || moduleScren?.title === null
              ? moduleScren?.title
              : 'Worksheet'
          }`}
          isBackButton
        ...
        <ScrollView
                ...
                <LinearGradient
                  ...
                  <View
                    ...
                    <TouchableOpacity
                      ...
                      onPress={() => {
                        const url = moduleScren?.submitted_worksheet_url
                          ? moduleScren?.submitted_worksheet_url
                          : moduleScren?.worksheet_url;
                        {
                          gotoSideMenuLinks(
                            'Worksheet',
                            url,
          ...
          {console.log(
            'moduleScren?.is_complete',
            moduleScren?.course_thumbnail,
          )}
          {console.log('my module screenstatus--->>', moduleScren?.is_complete)}
          {route?.params?.type === 'worksheet' ||
          route?.params?.type === 'quiz' ? null : (
            <TouchableOpacity
              style={
              ...
              onPress={() => {
                markAsCompleted(moduleScren?.id, moduleScren?.is_complete);
              }}>
              {moduleScren?.is_complete === 0 ? (
                <TickDark></TickDark>
              ) : (
                <Image
                  source={require('../../Global/Images/tickWhiteCircle.png')}></Image>
              )}
              <MyText
                text={
                  moduleScren?.is_complete === 0
                ...
                fontSize={14}
                textColor={
                  moduleScren?.is_complete === 0 ? Color.PRIMARY : Color.WHITE
                }
                fontFamily="Roboto"
          ...
          <View style={styles.buttonRow}>
            <TouchableOpacity
              style={
                moduleScren?.is_favourite === 0
                  ? styles.buttonClick
                  : [styles.buttonClick, {backgroundColor: 'white'}]
              }
              onPress={() => {
              ...
              <MyText
                ...
                fontSize={14}
                textColor={
                  moduleScren?.is_favourite === 0 ? Color.WHITE : Color.PRIMARY
                }
            ...
            <TouchableOpacity
              style={
                moduleScren?.is_saved === 0
                  ? [styles.buttonClick, {backgroundColor: Color.LIGHT_BLACK}]
                  : [
                      styles.buttonClick,
                      {
              ...
              <MyText
                ...
                fontSize={14}
                textColor={
                  moduleScren?.is_saved === 0 ? Color.WHITE : Color.LIGHT_BLACK
                }
                style={{marginHorizontal: 3}}
              />
            </TouchableOpacity>
          ...
          <View style={styles.ViewDescription}>
            <MyText
              text={
                moduleScren?.title === null ? 'Chapter 3' : moduleScren?.title
              }
              fontWeight="bold"
              fontFamily="Roboto"
              fontSize={16}
