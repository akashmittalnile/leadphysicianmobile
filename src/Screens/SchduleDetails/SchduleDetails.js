                        ...
                        <View
                            ...
                            >
                                ...
                                <View style={{ flexDirection: 'row', justifyContent: 'space-between', marginHorizontal: 12, }}>
                                    <View style={{ flexDirection: 'column', width: dimensions.SCREEN_WIDTH * 0.53 }}>
                                        <MyText
                                        ...
                                        <View style={{ flexDirection: 'row', marginTop: 4 }}>
                                            <Clock></Clock>
                                            <MyText
                                                text={`${moment(profile.schedule_start_time, "HH:mm:ss").format("hh:mm A")}-${moment(profile.schedule_end_time, "HH:mm:ss").format("hh:mm A")}` !== undefined ? `${moment(profile.schedule_start_time, "HH:mm:ss").format("hh:mm A")}-${moment(profile.schedule_end_time, "HH:mm:ss").format("hh:mm A")}` : ''}
                                                fontFamily="Roboto"
                                                fontWeight='400'
                                                fontSize={13}
                                                textColor={'#132A3A'}
                                ...
                                <View style={{ flexDirection: 'row', paddingBottom: 10, width: dimensions.SCREEN_WIDTH, alignSelf: 'center', justifyContent: 'center', }}>
                                    ...
                                    <Hyperlinks
                                        text={profile?.zoom_link != undefined ? profile?.zoom_link : ''}
