          ...
          <WebView
            source={
              route?.params?.params === 'Privacy'
                ? {
                    uri: 'https://www.leadphysician.org/pages/terms',
                  }
                : route?.params?.params === 'About'
                ? {
                    uri: 'https://www.leadphysician.org/about-us',
                  }
                : route?.params?.params === 'Facebook'
                ? {
                    uri: 'http://facebook.com/groups/DrKoh/',
                  }
                : route?.params?.params === 'Youtube'
                ? {
                    uri: 'http://bit.ly/DrKohYouTube',
                  }
                : route?.params?.params === 'Instagram'
                ? {
                    uri: 'http://instagram.com/dr.elsiekoh/?hl=en',
                  }
                : route?.params?.params === 'Linkdin'
                ? {
                    uri: 'http://linkedin.com/in/elsie-koh-md',
                  }
                : route?.params?.params === 'Twitter'
                ? {
                    uri: 'http://www.twitter.com/DrElsieKoh',
                  }
                : {
                    uri: 'https://www.leadphysician.org/pages/privacy-policy',
                  }
            }
            // Other WebView props...
          />
