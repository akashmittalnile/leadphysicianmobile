...
//import : styles
import { styles } from './SummaryWorksheetStyle';
...
const SummaryWorksheet = ({ navigation, dispatch, route }) => {
    ...
    const getCartCount = async () => {
        ...
        try {
            ...
            if (resp?.data?.status) {
                console.log('klklkll in other screennnn----->>>>', resp?.data?.data?.title)
    ...
    return (
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={styles.container}>
                <MyHeader Title={moduleScreen.title ? moduleScreen.title : ''} isBackButton
                ...
                <ScrollView
                    ...
                    <View style={{ width: dimensions.SCREEN_WIDTH * 0.90, height: 'auto', backgroundColor: Color.PRIMARY, marginTop: 20, borderRadius: 30 }}>
                        ...
                        <Image
                            ...
                            style={{ height: 54, width: 54, borderRadius: 50, alignSelf: 'center', marginVertical: 12 }}
                        />
                        <MyText text={`${user?.first_name} ${user?.last_name}`} fontWeight='500' fontSize={14} textColor={Color.WHITE} fontFamily='Roboto' style={{ alignSelf: 'center', }} />
                        ...
                        <MyText text={moduleScreen?.is_complete === 1 && moduleScreen?.is_complete !== undefined ? 'Congratulations!' : ''} fontWeight='500' fontSize={24} textColor={Color.WHITE} fontFamily='Roboto' style={{ alignSelf: 'center', marginTop: 12 }} />
                        <MyText text={moduleScreen?.is_complete === 1 && moduleScreen?.is_complete !== undefined ? 'Quiz Passed!' : 'Quiz Failled!'} fontWeight='400' fontSize={18} textColor={Color.WHITE} fontFamily='Roboto' style={{ alignSelf: 'center', marginBottom: 20 }} />
                        <View style={{
                            width: 63,
                            height: 63,
                            justifyContent: 'center',
                            ...
                            <Progress.Circle
                                size={155}
                                progress={moduleScreen?.percentage_obtained !== undefined ? moduleScreen?.percentage_obtained / 100 : 0.0}
                                thickness={6}
                            ...
                            <MyText text={moduleScreen?.percentage_obtained ? `${moduleScreen?.percentage_obtained}%` : '0%'} fontWeight='500' fontSize={29} textColor={Color.LIGHT_BLACK} fontFamily='Roboto' style={{ alignSelf: 'center', alignSelf: 'center', position: 'absolute', top: -10, width: 124, textAlign: 'self', textAlign: 'center' }} />
                            <MyText text={'OVERALL SCORE'} fontWeight='500' fontSize={14} textColor={Color.WHITE} fontFamily='Roboto' style={{ position: 'absolute', top: 40, width: 128, alignSelf: 'center', textAlign: 'center' }} />
                        </View>
                    ...
                    <View style={{
                        ...
                        height: 'auto', padding: 10, borderRadius: 5, marginVertical: 12
                    }}>
                        <MyText
                            text={moduleScreen?.title !== undefined ? moduleScreen?.title : null}
                            fontWeight='bold'
                            fontFamily="Roboto"
                            fontSize={16}
                            textColor={Color.LIGHT_BLACK}
                    ...
                    {moduleScreen?.is_complete === 1 && moduleScreen?.is_complete !== undefined
                        ? null : <TouchableOpacity style={styles.buttonBack} onPress={() => { gotoSideMenuLinks(moduleScreen?.title, moduleScreen?.quiz_url, moduleScreen, type = 'quiz') }}>
                            {/* <Arrow></Arrow> */}
                            <MyText text={'Retake Quiz'} fontWeight='500' fontSize={14} textColor={Color.WHITE} fontFamily='Roboto' style={{ alignSelf: 'center', marginVertical: 12, marginLeft: 12 }} />
                        </TouchableOpacity>}
...
//     dispatch,
// });
export default SummaryWorksheet;
