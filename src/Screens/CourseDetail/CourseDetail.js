            ...
            >
                ...
                <View>
                    <MyText
                        ...
                        style={{ width: dimensions.SCREEN_WIDTH * 0.52, justifyContent: 'center', marginTop: 9 }}
                    />
                    <MyText
                        ...
                        style={{ width: dimensions.SCREEN_WIDTH * 0.52, justifyContent: 'center', }}
                    />
                </View>



                <TouchableOpacity style={styles.arrowVew} onPress={() => navigation.navigate('ModuleListing', { id: item.id })
                } >
                    <Arrow></Arrow>
                </TouchableOpacity>
            </TouchableOpacity >
        ...
        <SafeAreaView style={{ flex: 1 }}>
            ...
            <View style={styles.container}>
                ...
                <ScrollView
                    ...
                    <View style={{ width: dimensions.SCREEN_WIDTH * 0.90, height: 'auto', backgroundColor: 'white', marginTop: 20, borderRadius: 10 }}>
                        ...
                        <View style={{ flexDirection: 'row', marginHorizontal: 12, marginTop: 12 }}>
                            ...
                            <View style={{ flexDirection: 'column', marginHorizontal: 12, width: dimensions.SCREEN_WIDTH * 0.70 }}>
                                ...
                                <View style={{ flexDirection: 'row', marginVertical: 10 }}>
                                    ...
                                    <MyText text={myCoursesDetail?.avg_review} fontWeight='400' fontSize={14} textColor={'#959FA6'} fontFamily='Roboto' style={{ marginHorizontal: 4 }} />
                        ...
                        <MyText text={myCoursesDetail?.description} fontWeight='400' fontSize={14} textColor={'#66757F'} fontFamily='Roboto' style={{ alignSelf: 'center', marginHorizontal: 14, }} />

                        {/* progress bar functionality */}
                        <View style={{ alignSelf: 'center', marginVertical: 12, }}>
                            <Progress.Bar progress={
                                parseFloat(myCoursesDetail?.course_complete_percentage || '0') / 100
                        ...
                        <View style={{ backgroundColor: '#F3F8E1', height: 'auto', width: dimensions.SCREEN_WIDTH * 0.90, paddingVertical: 12, borderBottomLeftRadius: 10, borderBottomRightRadius: 10, marginTop: 7 }}>
                            <View style={{ flexDirection: 'row', justifyContent: 'space-between', width: dimensions.SCREEN_WIDTH * 0.85, marginHorizontal: 9, }}>
                                ...
                                <View style={{ flexDirection: 'row' }}>
                                    <Chapter></Chapter>
                                    <MyText text={`${myCoursesDetail?.modules_count} modules`} fontWeight='400' fontSize={13} textColor={'#6A6A6A'} fontFamily='Roboto' style={{ alignSelf: 'center', lineHeight: 24, marginHorizontal: 6 }} />
                                </View>
                                <View style={{ flexDirection: 'row' }}>
                                    <Calendar height={22} width={22}></Calendar>
                                    <MyText text={myCoursesDetail?.created_date} fontWeight='400' fontSize={13} textColor={'#6A6A6A'} fontFamily='Roboto' style={{ alignSelf: 'center', lineHeight: 24, marginHorizontal: 6 }} />
                                </View>
                            </View>
                        </View>
                ...
                <View style={{ marginTop: responsiveHeight(0) }}>
                    <FAB_Button bottom={responsiveHeight(1)} style={{ tintColor: 'white' }} onPress={openReviewModal} />
                </View>
                {showViewPdfModal ? (
                    <ViewPdf
